			...
			<?php 
				...
				while($p=mysqli_fetch_array($periksa_bahan)){	
					if($p['stock']<=1){	
						...
						<?php
						echo "<div class='alert alert-danger alert-dismissible fade show'><button type='button' class='close' data-dismiss='alert'>&times;</button>Stok  <strong><u>".$p['nama']. "</u> Merk : <u>".($p['merk'])."</u> &nbsp </strong> yang tersisa sudah habis</div>";		
					}
				}
				?>
										 ...
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
                                                    ...
                                                    <td><?php $tanggals=$p['tgl']; echo date("d-M-Y", strtotime($tanggals)) ?></td>
                                                    ...
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <select name="lokasi" class="custom-select form-control">
                                                                ...
                                                                <option value="R. Server Depan">R. Server Depan</option>
                                                                <option value="R. Server Belakang">R. Server Belakang</option>
                                                            </select>
