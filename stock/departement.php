...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update departement set nama_departement='$nama', kode='$jenis' where id_departemen='$idx'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= departement.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from departement where id_departemen='$idx'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../logoleibel.png" alt="logo" width="100%"></a>
            </div>
            <div class="main-menu">
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="departement.php"><i class="ti-home"></i><span>Daftar Departement</span></a>
                            </li>
							<li>
                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Daftar Departement</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right" style="color:black; padding:0px;">
                            <img src="log.png" width="220px" class="user-name dropdown-toggle" data-toggle="dropdown"\>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from departement order by nama_departement ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<td><?php echo $no++ ?></td>
													<td><?php echo $p['nama_departement'] ?></td>
                                                ...
                                                <!-- The Modal -->
                                                    <div class="modal fade" id="edit<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <h4 class="modal-title">Edit Departement <?php echo $p['id_departemen']?> - <?php echo $p['nama_departement']?> - <?php echo $p['kode']?></h4>
                                                            ...
                                                            <input type="text" id="nama" name="nama" class="form-control" value="<?php echo $p['nama_departement'] ?>">

                                                            <label for="jenis">Kode Departement</label>
                                                            <input type="text" id="jenis" name="jenis" class="form-control" value="<?php echo $p['kode'] ?>">
                                                    ...
                                                    <div class="modal fade" id="del<?=$idb;?>">
                                                        ...
                                                        <form method="post">
                                                            <!-- Modal Header -->
                                                            <div class="modal-header">
                                                            <h4 class="modal-title">Hapus Barang <?php echo $p['nama_departement']?> - <?php echo $p['kode']?> - <?php echo $p['id_departemen']?></h4>
                                                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                            </div>
	...
	<!-- modal input -->
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan data departement</h4>
						</div>
						<div class="modal-body">
							<form action="tambah_dp.php" method="post">
