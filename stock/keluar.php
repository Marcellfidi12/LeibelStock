...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        if($jumlah <= $qtyskrg){
            ...
            $updatedata1 = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal',jumlah='$jumlah',penerima='$penerima',keterangan='$keterangan',departement='$departement' where id='$id'");    
            ...
            if($tambahistock >= 0){
                ...
                $updatedata = mysqli_query($conn,"update sbrg_keluar set tgl='$tanggal', jumlah='$jumlah', penerima='$penerima', keterangan='$keterangan',departement='$departement' where id='$id'");
                ...
                echo "<div class='alert alert-warning'>
                        <strong>Failed!</strong> stock kurang!!!.
                    </div>
                    <meta http-equiv='refresh' content='3; url= keluar.php'/> ";
            }
											...
											while($b=mysqli_fetch_array($brg)){
                                                ...
                                                <div class="modal fade" id="edit<?=$id;?>">
                                                        ...
                                                        <form method="post">
                                                            ...
                                                            <select name="departement" class="custom-select form-control">
                                                            <option selected>Pilih departement</option>
                                                            <?php
                                                            $det=mysqli_query($conn,"select * from departement order by nama_departement ASC");
                                                            while($d=mysqli_fetch_array($det)){
                                                            ?>
                                                                <option value="<?php echo $d['nama_departement'] ?>"><?php echo $d['nama_departement'] ?> (<?php echo $d['kode'] ?>)</option>
                                                                <?php
                                                            }
                                                            ?>
